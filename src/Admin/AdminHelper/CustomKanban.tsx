...
const Card: React.FC<
  CardType & { handleDragStart: (e: DragEvent, card: CardType) => void }
...
const AddCard: React.FC<AddCardProps> = ({ column, setCards }) => {
  ...
  if (!form) {
    return (
      <button
        ...
        className="mt-3 flex w-full items-center gap-2 rounded border border-dashed border-neutral-700 bg-neutral-800/60 py-3 text-sm text-neutral-400"
      >
        <FiPlus /> Add a card
      </button>
    );
  ...
  return (
    <form
      ...
      className="mt-3 flex w-full flex-col gap-2 rounded border border-neutral-700 bg-neutral-800/60 p-3"
    >
