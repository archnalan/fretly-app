...
export const detailsPage = {
  ...
  innerContainer: (theme: string) =>
    `${theme === "dark" ? "text-neutral-200" : "text-dark"} w-3/4 md:w-1/2 border bg-base-100 px-5 pt-3 pb-3 rounded-xl mt-[5rem] shadow-xl`,
  revertContainer: "flex items-center text-primary",
  revertButton:"text-xl me-2",
  header: "text-2xl my-4",
  backHeaderButton:"text-3xl hover:opacity-75 hover:scale-90 me-4",
  detailRow: "flex flex-col md:flex-row justify-between mt-4",
