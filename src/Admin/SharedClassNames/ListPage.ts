...
export const listPage = {
  ...
  header: "m-3 text-3xl mt-8 text-primary min-w-[15rem] font-semibold",
  ...
  contentContainer:
    "w-3/4 rounded-xl bg-base-100 shadow-md p-3 min-w-[15rem] mb-2",
  searchContainer: "flex justify-between",
  searchInputContainer: "flex w-1/2 justify-start items-center relative me-5",
  searchInput:
    "h-full input input-bordered w-full pl-10 rounded-md placeholder-primary placeholder-opacity-50",
  searchButton: "btn btn-link absolute border-none",
  createLinkContainer:
    "flex items-center border border-base-200 rounded-r-md px-2 btn btn-neutral text-primary bg-transparent hover:bg-opacity-30 hover:border-base-300",
  createLinkLabel: "cursor-pointer me-2",
  createButton: "text-primary text-2xl",
  tableContainer: "w-3/4 overflow-y-hidden overflow-x-auto h-fit",
  table: (theme: theme) =>
    `${
      theme === "dark" ? "text-neutral-300" : ""
    } table align-middle bg-base-100`,
  tableHead: "text-base",
  ...
  tableSkelton:
    "skeleton w-full h-[1.5rem]  px-[0.25rem] border-none my-[0.5rem] ",
  tdDropContainer: "dropdown dropdown-right ",
  dropdownButton: "btn btn-ghost btn-circle",
  ulDropdown:
    "dropdown-content menu menu-compact bg-base-100 rounded-box w-52 shadow absolute right-0 mt-2 z-1 border",
  liElement: "w-full",
  linkItem: "me-2 flex items-center",
  iconStyle: "mr-2",
  listDeleteButton:
    "btn btn-error btn-sm bg-opacity-75 flex items-center justify-start",
  ...
  deleteButton:
    "btn btn-error btn-sm bg-opacity-75 flex items-center justify-start",
  paginationContainer:
    "flex justify-center fixed bottom-5 bg-base-150 shadow-md rounded-xl border",
};
